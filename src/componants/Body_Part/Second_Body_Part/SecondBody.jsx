    ...
    <div className="container" style={Second_Body}>
      <div className="second_main">
        <div className="coverup">
          ...
          <img src="https://www.crunchyroll.com/animeawards/static/vector-top-lg-89b9d27de020bf6dd07d9d8f1fc4c17d.png" alt="CoverUp"/>
          ...
          <video src="/assets/top-thread.mp4" autoPlay loop playsInline muted></video>
        </div>
        <div className="text">
